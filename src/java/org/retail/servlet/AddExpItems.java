 ...
 * @author Givindu
 */
@WebServlet(name = "AddExpItems", urlPatterns = {"/AddExpItems"})
public class AddExpItems extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(AddExpItems.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
